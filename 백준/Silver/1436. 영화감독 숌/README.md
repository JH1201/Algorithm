...
### 문제 설명
"666"이 연속으로 들어가기만 하면 되는 숫자를 작은 수부터 차례대로 카운팅 
...
- 4666 ->  다섯 번째
- 5666 -> 여섯 번째
- 6660 -> 일곱 번째 (6666 > 6660)

### 규칙 
- i 를 1씩 증가 시켜서 "666"이 포함 되는지 확인
- 포함 된다면 res 값에 1을 더해 while 탈출 조건 확인
- 포함되지 않는다면 i 값을 계속 증가 시킴 ("666"이 포함 될 때까지)
- res == N 일 때 while문 탈출
